  ...
  return (
    <AppLayout>
      ...
      <div className="relative flex flex-col-reverse py-16 lg:flex-col lg:pb-0 lg:pt-0">
        <div className="inset-y-0 right-0 top-0 z-0 mx-auto w-full max-w-xl px-2 md:px-0 lg:absolute lg:mx-0 lg:mb-0 lg:w-7/12 lg:max-w-full lg:pr-0 xl:px-0">
          <div className="absolute right-10 top-96 z-50 duration-1000">
        ...
        <div className="relative mx-auto flex w-full max-w-xl flex-col items-start lg:max-w-screen-2xl">
          <div className="lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <div className="flex items-center">
              <Button className="rounded-2xl px-9 py-7 font-extrabold text-amber-100 shadow-lg">
      ...
      <h1 className="pt-5 text-xl font-bold tracking-tight sm:text-center sm:text-2xl">
        Our Partnership :
      </h1>
      <MovingCardsPartner />
      {/* <MovingCardsTestimoni /> */}
    </AppLayout>
  );
}
