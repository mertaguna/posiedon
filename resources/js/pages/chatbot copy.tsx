        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-xl">
            <DialogHeader>
              ...
              <div className="h-[600px] transition-all duration-300 md:bottom-32">
                {/* bot body */}
                <div ref={chatBodyRef} className="h-[90%] overflow-y-auto p-4">
                  <div className="flex flex-col gap-2">
                    <div className="flex max-w-lg items-end gap-2">
                      <div className="rounded-full bg-primary p-2 text-white">
                        <Bot />
                      </div>
                      <div className="self-start rounded-br-xl rounded-tl-xl rounded-tr-xl bg-primary/5 p-4 text-xs lg:text-sm">
    ...
    <>
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className="h-screen">
          ...
          <div className="fixed bottom-0 h-screen w-full overflow-hidden rounded-xl bg-white shadow-xl transition-all duration-300 md:bottom-32 md:right-8 md:h-[600px] md:max-w-sm">
            <div className="flex w-full items-center justify-between p-4">
              <div className="flex items-center justify-center gap-2">
                <AppLogo className="size-8" />
                <h1 className="text-xl font-bold">Garbot</h1>
